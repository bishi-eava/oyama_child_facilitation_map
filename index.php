    ...
    function displayFacilities(facilities) {
      ...
      facilities.forEach(facility => {
            ...
            if (facility.installation_position && facility.installation_position.trim() !== '') {
              popupContent += `<br>🚶 アクセス: ${facility.installation_position}`;
            }
            ...
            if (facility.pediatric_support && facility.pediatric_support.trim() !== '') {
              ...
              popupContent += `<br>🍼 一時預かり: <span style="color:${supportColor}; font-weight:bold;">${facility.pediatric_support}</span>`;
            }
